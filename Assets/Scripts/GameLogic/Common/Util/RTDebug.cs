...
{	
	/// <summary>
    /// Show Debug Info When Runing
	/// Various static methods used throughout the Infinite Runner Engine
	/// </summary>

	public static class RTDebug 
	{
		public static RTConsole _console; 
		...
		public static void InstantiateOnScreenConsole(int fontSize=10)
		{
			if (_console == null)
			{
				...
				_console = newGameObject.AddComponent<RTConsole>();
        ...
        /// <summary>
        /// Draw Bounds On OnDrawGizmos When Runing
        /// </summary>
        /// <param name="bounds"></param>
        /// <param name="color"></param>
        public static void DrawGizmosBounds(Bounds bounds, Color color)
        {
            Vector3 boundsCenter = bounds.center;
            Vector3 boundsExtents = bounds.extents;
